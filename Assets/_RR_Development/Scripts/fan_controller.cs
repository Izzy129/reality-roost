...
public class DeviceController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (cur_n1_f != last_n1_f) Debug.Log($"[RR][DEBUG] FanController: Node1 speed {last_n1_f} -> {cur_n1_f}");
            if (cur_n1_s1 != last_n1_s1) Debug.Log($"[RR][DEBUG] FanController: Node1 pitch {last_n1_s1} -> {cur_n1_s1}");
            if (cur_n1_s2 != last_n1_s2) Debug.Log($"[RR][DEBUG] FanController: Node1 yaw {last_n1_s2} -> {cur_n1_s2}");
        ...
        {
            if (cur_n2_f != last_n2_f) Debug.Log($"[RR][DEBUG] FanController: Node2 speed {last_n2_f} -> {cur_n2_f}");
            if (cur_n2_s1 != last_n2_s1) Debug.Log($"[RR][DEBUG] FanController: Node2 pitch {last_n2_s1} -> {cur_n2_s1}");
            if (cur_n2_s2 != last_n2_s2) Debug.Log($"[RR][DEBUG] FanController: Node2 yaw {last_n2_s2} -> {cur_n2_s2}");
